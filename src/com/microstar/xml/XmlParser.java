...
// $Id: XmlParser.java,v 1.1.1.1 2008/04/17 04:26:17 sixbynine Exp $
...

    ...
    throws java.lang.Exception
  {
    ...
    if (type == ATTRIBUTE_ENUMERATED || type == ATTRIBUTE_NOTATION) {
      enum_rep = dataBufferToString();
    }

				// Read the default value.
    requireWhitespace();
    parseDefault(elementName, name, type, enum_rep);
  }
  ...
  /**
    ...
    */
  void parseDefault (String elementName, String name, int type, String enum_rep)
    throws java.lang.Exception
  {
    ...
    setAttribute(elementName, name, type, enum_rep, value, valueType);
  }
